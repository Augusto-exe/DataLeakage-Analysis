...
if __name__ == "__main__":
    ...
    parser.add_argument("--test", type=str, required=True, help="Type of test to run: normalization, feature_selection, tuning, or imputation.")
